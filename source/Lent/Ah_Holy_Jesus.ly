...
alto = {
	a2 <e' a>4 <d' a> <e' c'>2 <e' c'> bes2 c'4 d' c'2 a
	bes2 <c' a>4 d' e'2 f' f'4. c'8 c'4 f' e'2 <e' c'>
	<f' d'>2 g'4 a'~ a' (g') e'2 f'4. e'8 f'4 g' f' (e') d'2
	<e' c'>2 bes c'4 (d'~ d' c'8[ bes]) a1

}

tenor = {
 	f2 a4 f g2 a f4. g8 f4 bes a (g) f2
	f2 f4 a c'2 c' d'4. g8 f4 f g2 a
	<a d'>2 <g c'>4 <a f'>~ <c' f'> d'~ d' c' a4. bes8 c'4 d' c'2 a
	a2 f4 g a (bes4 g2~ g) f
}

bass = {
 	d2 c4 d c2 a, bes,4. g,8 a,4 bes, c2 d4 (c)
	bes,2 f,4 d c2 f4 (e) d4. e8 f4 d c (e) a,2
	d,2 e,4 d,4 <f, f> <g, g> <a, a>2 <f, f>4. <g, g>8 <a, a>4 <g, g> <a, a> (<c g>) d2
