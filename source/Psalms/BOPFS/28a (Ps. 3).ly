...
{
	You are my sheild and glo -- ry, \markup { \smallCaps "Lord;" } You lift -- ed up my head.
...
sopWordsThree = \lyricmode
{
	...
	I will not fear ten tou -- sand men En -- trenched sur -- round -- ing me.
}
...
{
	De -- liv -- er -- ance if from the \markup { \smallCaps "Lord," } Sal -- va -- taion His a -- lone!
