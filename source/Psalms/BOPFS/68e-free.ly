...
sopWords = \lyricmode
{
	O __ all ye king -- doms of the earth, Sing prais -- es to this King;
	For He is Lord that rul -- eth all, Un -- to Him prais -- es sing,
	Un -- to Him prais -- es sing.
}
...
sopWordsThree = \lyricmode
{
 	\skipFour
	\set stanza = "(Tenor)"
	Un -- to Him prais -- es sing, Un -- to Him prais -- es sing.
}
...
\markup { \hspace #5 
 \columns  { 
  ...
  \column { \line {
     "4. "
     \column {
       	"Dread art Thou from Thy temple, Lord;"
