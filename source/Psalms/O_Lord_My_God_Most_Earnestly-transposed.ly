...
musicScore = \context StaffGroup <<
   \new ChordNames \transpose d e \chordmode { \set majorSevenSymbol = "maj7"
    ...
    \context Staff = "upper" <<
      ...
      \clef treble
      \context Voice = "one" { \global \voiceOne \transpose d e \soprano }
      \context Voice = "two" { \global \voiceTwo \transpose d e \alto }
    >>
    ...
    \context Staff = "lower" <<
      \clef bass
      \context Voice = "one" { \global \voiceThree \transpose d e \tenor }
      \context Voice = "two" { \global \voiceFour \transpose d e \bass }
    >>
